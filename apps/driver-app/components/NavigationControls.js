...
const NavigationControls = ({
  ...
  useEffect(() => {
    if (showRouteOptions && ride) {
      loadAlternativeRoutes();
    }
  }, [showRouteOptions, ride]);
  ...
  const loadAlternativeRoutes = async () => {
    try {
      ...
      const routes = await navigationService.getAlternativeRoutes(currentLocation, destination);
  ...
  const handleExternalNavigation = async (app = 'default') => {
    try {
      ...
      if (supported) {
        ...
        onExternalNavigation && onExternalNavigation(app);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainControls}>
        ...
        >
          ...
          <Text style={styles.optionsButtonText}>Routes</Text>
        </TouchableOpacity>
      </View>
              ...
              {loading ? (
                ...
                alternativeRoutes.map((route, index) => (
                  ...
                  >
                    ...
                    <View style={styles.routeOptionBadges}>
                      {route.tolls && (
